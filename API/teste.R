...
testar_endpoint("/analise/pearson_grafico", dados_correlacao_teste, "Correlação de Pearson (Gráfico)")
...
testar_endpoint("/analise/spearman_grafico", dados_correlacao_teste, "Spearman (Gráfico)")
testar_endpoint("/analise/kendall", dados_correlacao_teste, "Kendall")
testar_endpoint("/analise/kendall_grafico", dados_correlacao_teste, "Kendall (Gráfico)")
...
testar_endpoint("/analise/modelo_gamma_grafico", dados_glm_gamma_teste, "Modelo Gamma (Gráfico)")
testar_endpoint("/analise/modelo_poisson", dados_glm_teste, "Modelo Poisson")
testar_endpoint("/analise/modelo_poisson_grafico", dados_glm_teste, "Modelo Poisson (Gráfico)")
testar_endpoint("/analise/modelo_binomial_negativa", dados_glm_teste, "Modelo Binomial Negativa")
testar_endpoint("/analise/modelo_binomial_grafico", dados_glm_teste, "Modelo Binomial Negativa (Gráfico)")
