...
import {
  EventoAmostragem,
  EventoAmostragemCreate,
  EventoAmostragemUpdate,
} from "../../models";
...
export class EventoAmostragemService extends BaseService {
  ...
  listar(
    ...
    return this.get<EventoAmostragem[]>(
      this.base(estudo_id, campanha_id, unidade_id),
    );
  }
