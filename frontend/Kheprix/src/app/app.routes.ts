...
export const routes: Routes = [
  ...
  },
  {
    ...
    loadComponent: () => import('./pages/cadastro-rapido/cadastro-rapido.component').then(m => m.CadastroRapidoComponent),
    canActivate: [authGuard],
  },
  {
    path: 'convites',
  ...
  },
  {
    ...
    loadComponent: () => import('./pages/estudos/editar/estudo-editar.component').then(m => m.EstudoEditarComponent),
    canActivate: [authGuard],
  },
  {
    path: 'estudos/:estudo_id/colaboradores',
    loadComponent: () => import('./pages/estudos/colaboradores/colaboradores.component').then(m => m.ColaboradoresComponent),
    canActivate: [authGuard],
  },
  ...
  // Espécies
  {
    ...
    loadComponent: () => import('./pages/especies/lista/especies-lista.component').then(m => m.EspeciesListaComponent),
    canActivate: [authGuard],
  },
  {
    path: 'estudos/:estudo_id/especies/novo',
    loadComponent: () => import('./pages/especies/novo/especie-novo.component').then(m => m.EspecieNovoComponent),
    canActivate: [authGuard],
  },
  {
    path: 'estudos/:estudo_id/especies/:especie_id',
    loadComponent: () => import('./pages/especies/detalhe/especie-detalhe.component').then(m => m.EspecieDetalheComponent),
    canActivate: [authGuard],
  },
  {
  ...
  // Campanhas
  {
    ...
    loadComponent: () => import('./pages/campanhas/lista/campanhas-lista.component').then(m => m.CampanhasListaComponent),
    canActivate: [authGuard],
  },
  {
    path: 'estudos/:estudo_id/campanhas/novo',
    loadComponent: () => import('./pages/campanhas/novo/campanha-novo.component').then(m => m.CampanhaNovoComponent),
    canActivate: [authGuard],
  },
  {
  ...
  },
  {
    ...
    loadComponent: () => import('./pages/unidades/novo/unidade-novo.component').then(m => m.UnidadeNovoComponent),
    canActivate: [authGuard],
  },
  {
  ...
  // Eventos de Amostragem
  {
    ...
    loadComponent: () => import('./pages/eventos/lista/eventos-lista.component').then(m => m.EventosListaComponent),
    canActivate: [authGuard],
  },
  {
    path: 'estudos/:estudo_id/campanhas/:campanha_id/unidades/:unidade_id/eventos/novo',
    loadComponent: () => import('./pages/eventos/novo/evento-novo.component').then(m => m.EventoNovoComponent),
    canActivate: [authGuard],
  },
  {
  ...
  // Registros de Ocorrência
  {
    ...
    loadComponent: () => import('./pages/registros/lista/registros-lista.component').then(m => m.RegistrosListaComponent),
    canActivate: [authGuard],
  },
  {
    path: 'estudos/:estudo_id/campanhas/:campanha_id/unidades/:unidade_id/eventos/:evento_id/registros/novo',
    loadComponent: () => import('./pages/registros/novo/registro-novo.component').then(m => m.RegistroNovoComponent),
    canActivate: [authGuard],
  },
  {
  ...
  },
  {
    ...
    loadComponent: () => import('./pages/registros/detalhe/registro-detalhe.component').then(m => m.RegistroDetalheComponent),
    canActivate: [authGuard],
  },
