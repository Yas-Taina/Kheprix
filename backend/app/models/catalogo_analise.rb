...
class CatalogoAnalise
  ANALISES = [
    # === Modelos de Distribuição (somente gráfico, tipo: abundancias) ===
    ...
    # === Rarefação (somente JSON, tipo: abundancias) ===
    ...
    # === Estimadores de Riqueza (somente JSON) ===
    ...
    # === Índices de Diversidade (somente JSON, tipo: abundancias) ===
    ...
    # === Correlações (pareadas: JSON + gráfico, tipo: dois_vetores) ===
    ...
    # === Regressão (somente gráfico, tipo: dois_vetores) ===
    ...
    # === Índices de Similaridade (pareadas: JSON + gráfico, tipo: abundancias_por_amostra) ===
    ...
    # === Análises Multivariadas (somente gráfico) ===
    ...
    # === Modelos GLM (pareadas: JSON + gráfico, tipo: dois_vetores) ===
    ...
    # === Curva de Acumulação (somente gráfico, tipo: matriz_acumulacao) ===
